...
public class Application {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * 创建缓冲线程池的正确姿势
		 */
		ExecutorService  executor = new ThreadPoolExecutor(corePoolSize, corePoolSize+1, 100L, TimeUnit.SECONDS,
				new LinkedBlockingQueue<Runnable>(1000),nameFactory,new ThreadPoolExecutor.AbortPolicy());
		/**
		 * 创建LongEvent事件工厂
		 */
