...
public class ApyAccountRepository {
     ...
     */
    {
        ...
        apyAccount1.setFileType(FileType.TEXT);
        //设置测试环境
        ...
        apyAccount2.setFileType(FileType.XML);
        //设置测试环境
        ...
        apyAccount3.setFileType(FileType.XML);
        ...
        apyAccount4.setFileType(FileType.JSON);
